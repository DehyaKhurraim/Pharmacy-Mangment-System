...
<div class="active">
	...
	try{
		...
		ps.setString(1,name);
	 	rs=ps.executeQuery();
	   	if(!rs.next())
	   	{
	   response.sendRedirect("mednotfoundcus.jsp");
	   	}
	...
	String query="select p.pname,p.pid,p.manufacturer,p.mfg,p.price,i.quantity from product p,inventory i where  p.pname=? and p.pid=i.pid";
